...
const GenericProductCard = ({ adInfo }) => {
  if (adInfo) {
    return (
      <div className="genericproductcard">
        <div className="wrapper">
          ...
          <div className="right">
            <div className="title">{adInfo.adTitle}</div>
            <p className="desc">{adInfo.adDescription}</p>
            <div className="price">
              रु {adInfo.adPrice} | <span className="condition">{adInfo.adCondition}</span>
            </div>
            <div className="location">
              <span>{adInfo.adLocation}</span>
